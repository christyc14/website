...
less time as a developer I will rarely waste that occasion. You might think that you don't waste _that_ much time writing
...
In most cases, this is not something that you will want to do but it _is_ useful for very specific use cases like
